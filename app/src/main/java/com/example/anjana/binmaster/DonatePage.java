...
public class DonatePage extends AppCompatActivity implements NumberPicker.OnValueChangeListener{
   TextView tv;
    @Override
    ...
    public void show()
    {
        ...
        final Dialog d = new Dialog(DonatePage.this);
        ...
        b1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DonatePage.this);
